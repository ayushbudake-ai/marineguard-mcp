...
export default {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        firewallPulse: {
          "0%, 100%": { boxShadow: "0 0 0 0 rgba(226, 87, 76, 0.45)" },
          "50%": { boxShadow: "0 0 0 6px rgba(226, 87, 76, 0)" },
        },
        rowEnter: {
      ...
      animation: {
        "firewall-pulse": "firewallPulse 1.8s ease-out infinite",
        "row-enter": "rowEnter 0.35s ease-out",
      },
    },
  },
  plugins: [],
